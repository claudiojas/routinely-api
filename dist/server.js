...
var require_library = __commonJS({
  "src/generated/prisma/runtime/library.js"(exports2, module2) {
    ...
    var A = (e, r, t) => (t = e != null ? xu(Tu(e)) : {}, _o(r || !e || !e.__esModule ? Vt(t, "default", { value: e, enumerable: true }) : t, e));
    ...
    var ms = ne((zg, Uc) => {
      Uc.exports = { name: "@prisma/internals", version: "6.12.0", description: "This package is intended for Prisma's internal use", main: "dist/index.js", types: "dist/index.d.ts", repository: { type: "git", url: "https://github.com/prisma/prisma.git", directory: "packages/internals" }, homepage: "https://www.prisma.io", author: "Tim Suchanek <suchanek@prisma.io>", bugs: "https://github.com/prisma/prisma/issues", license: "Apache-2.0", scripts: { dev: "DEV=true tsx helpers/build.ts", build: "tsx helpers/build.ts", test: "dotenv -e ../../.db.env -- jest --silent", prepublishOnly: "pnpm run build" }, files: ["README.md", "dist", "!**/libquery_engine*", "!dist/get-generators/engines/*", "scripts"], devDependencies: { "@babel/helper-validator-identifier": "7.25.9", "@opentelemetry/api": "1.9.0", "@swc/core": "1.11.5", "@swc/jest": "0.2.37", "@types/babel__helper-validator-identifier": "7.15.2", "@types/jest": "29.5.14", "@types/node": "18.19.76", "@types/resolve": "1.20.6", archiver: "6.0.2", "checkpoint-client": "1.1.33", "cli-truncate": "4.0.0", dotenv: "16.5.0", esbuild: "0.25.5", "escape-string-regexp": "5.0.0", execa: "5.1.1", "fast-glob": "3.3.3", "find-up": "7.0.0", "fp-ts": "2.16.9", "fs-extra": "11.3.0", "fs-jetpack": "5.1.0", "global-dirs": "4.0.0", globby: "11.1.0", "identifier-regex": "1.0.0", "indent-string": "4.0.0", "is-windows": "1.0.2", "is-wsl": "3.1.0", jest: "29.7.0", "jest-junit": "16.0.0", kleur: "4.1.5", "mock-stdin": "1.0.0", "new-github-issue-url": "0.2.1", "node-fetch": "3.3.2", "npm-packlist": "5.1.3", open: "7.4.2", "p-map": "4.0.0", "read-package-up": "11.0.0", resolve: "1.22.10", "string-width": "7.2.0", "strip-ansi": "6.0.1", "strip-indent": "4.0.0", "temp-dir": "2.0.0", tempy: "1.0.1", "terminal-link": "4.0.0", tmp: "0.2.3", "ts-node": "10.9.2", "ts-pattern": "5.6.2", "ts-toolbelt": "9.6.0", typescript: "5.4.5", yarn: "1.22.22" }, dependencies: { "@prisma/config": "workspace:*", "@prisma/debug": "workspace:*", "@prisma/dmmf": "workspace:*", "@prisma/driver-adapter-utils": "workspace:*", "@prisma/engines": "workspace:*", "@prisma/fetch-engine": "workspace:*", "@prisma/generator": "workspace:*", "@prisma/generator-helper": "workspace:*", "@prisma/get-platform": "workspace:*", "@prisma/prisma-schema-wasm": "6.12.0-15.8047c96bbd92db98a2abc7c9323ce77c02c89dbc", "@prisma/schema-engine-wasm": "6.12.0-15.8047c96bbd92db98a2abc7c9323ce77c02c89dbc", "@prisma/schema-files-loader": "workspace:*", arg: "5.0.2", prompts: "2.4.2" }, peerDependencies: { typescript: ">=5.1.0" }, peerDependenciesMeta: { typescript: { optional: true } }, sideEffects: false };
    });
    var Pi = ne((ih, Jc) => {
      Jc.exports = { name: "@prisma/engines-version", version: "6.12.0-15.8047c96bbd92db98a2abc7c9323ce77c02c89dbc", main: "index.js", types: "index.d.ts", license: "Apache-2.0", author: "Tim Suchanek <suchanek@prisma.io>", prisma: { enginesVersion: "8047c96bbd92db98a2abc7c9323ce77c02c89dbc" }, repository: { type: "git", url: "https://github.com/prisma/engines-wrapper.git", directory: "packages/engines-version" }, devDependencies: { "@types/node": "18.19.76", typescript: "4.9.5" }, files: ["index.js", "index.d.ts"], scripts: { build: "tsc -d" } };
    });
    var tn = ne((rn) => {
      "use strict";
    ...
    var Rs = ne((Ih, ip) => {
      ip.exports = { name: "dotenv", version: "16.5.0", description: "Loads environment variables from .env file", main: "lib/main.js", types: "lib/main.d.ts", exports: { ".": { types: "./lib/main.d.ts", require: "./lib/main.js", default: "./lib/main.js" }, "./config": "./config.js", "./config.js": "./config.js", "./lib/env-options": "./lib/env-options.js", "./lib/env-options.js": "./lib/env-options.js", "./lib/cli-options": "./lib/cli-options.js", "./lib/cli-options.js": "./lib/cli-options.js", "./package.json": "./package.json" }, scripts: { "dts-check": "tsc --project tests/types/tsconfig.json", lint: "standard", pretest: "npm run lint && npm run dts-check", test: "tap run --allow-empty-coverage --disable-coverage --timeout=60000", "test:coverage": "tap run --show-full-coverage --timeout=60000 --coverage-report=lcov", prerelease: "npm test", release: "standard-version" }, repository: { type: "git", url: "git://github.com/motdotla/dotenv.git" }, homepage: "https://github.com/motdotla/dotenv#readme", funding: "https://dotenvx.com", keywords: ["dotenv", "env", ".env", "environment", "variables", "config", "settings"], readmeFilename: "README.md", license: "BSD-2-Clause", devDependencies: { "@types/node": "^18.11.3", decache: "^4.6.2", sinon: "^14.0.1", standard: "^17.0.0", "standard-version": "^9.5.0", tap: "^19.2.0", typescript: "^4.8.4" }, engines: { node: ">=12" }, browser: { fs: false } };
    });
    var Ds = ne((kh, Ne) => {
      "use strict";
      var Li = require("fs"), Fi = require("path"), op = require("os"), sp = require("crypto"), ap = Rs(), As = ap.version, lp = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
      function up(e) {
        let r = {}, t = e.toString();
        t = t.replace(/\r\n?/mg, `
`);
...
`), o = o.replace(/\\r/g, "\r")), r[i] = o;
    ...
    function Wu(e) {
      let r = { color: Bo[Qu++ % Bo.length], enabled: Yr.enabled(e), namespace: e, log: Yr.log, extend: () => {
      } }, t = (...n) => {
...
`);
    ...
    var Yo = A(require("child_process"));
    var fi = A(require("fs/promises"));
    var Kt = A(require("os"));
...
${c}`);
    ...
    var Ag = Zr === "Windows" || globalThis.navigator?.platform === "Win32" || globalThis.process?.platform === "win32";
    var Ig = Zr === "Linux" || globalThis.navigator?.platform?.startsWith("Linux") === true || globalThis.navigator?.userAgent?.includes(" Linux ") === true || globalThis.process?.platform === "linux";
    var kg = Zr === "iOS" || globalThis.navigator?.platform === "MacIntel" && globalThis.navigator?.maxTouchPoints > 1 || /iPad|iPhone|iPod/.test(globalThis.navigator?.platform);
    var Dg = Zr === "Android" || globalThis.navigator?.platform === "Android" || globalThis.navigator?.userAgent?.includes(" Android ") === true || globalThis.process?.platform === "android";
    var k = "\x1B[";
    var et = "\x1B]";
    var yr = "\x07";
    var Xr = ";";
...
Details: ${r.message}`;
    ...
    var nn = `${Es}:`;
    function on(e) {
      return e?.toString().startsWith(`${nn}//`) ?? false;
    }
    function Ai(e) {
...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    function _s(e) {
      if (Ep(e)) {
        ...
        let r = $i.default.config({ path: e, debug: process.env.DOTENV_CONFIG_DEBUG ? true : void 0 });
    ...
    var dn = "2.";
    var mn = "3.";
    var Bi = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -vr, maxE: vr, crypto: false };
    var js;
    var Le;
    var w = true;
    var gn = "[DecimalError] ";
    var He = gn + "Invalid argument: ";
    var Vs = gn + "Precision limit exceeded";
    var Bs = gn + "crypto unavailable";
    var Us = "[object Decimal]";
    var X = Math.floor;
    var U = Math.pow;
    var wp = /^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i;
    var xp = /^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i;
    var vp = /^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i;
    var Gs = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i;
    var fe = 1e7;
    var E = 7;
    ...
    m.cosine = m.cos = function() {
      ...
      return t.d ? t.d[0] ? (e = n.precision, r = n.rounding, n.precision = e + Math.max(t.e, t.sd()) + E, n.rounding = 1, t = Sp(n, Ks(n, t)), n.precision = e, n.rounding = r, y(Le == 2 || Le == 3 ? t.neg() : t, e, r, true)) : new n(1) : new n(NaN);
    };
    ...
    m.hyperbolicCosine = m.cosh = function() {
      ...
      t = s.precision, n = s.rounding, s.precision = t + Math.max(o.e, o.sd()) + 4, s.rounding = 1, i = o.d.length, i < 32 ? (e = Math.ceil(i / 3), r = (1 / yn(4, e)).toString()) : (e = 16, r = "2.3283064365386962890625e-10"), o = Pr(s, 1, o.times(r), new s(1), true);
    ...
    m.hyperbolicSine = m.sinh = function() {
      ...
      if (r = o.precision, t = o.rounding, o.precision = r + Math.max(i.e, i.sd()) + 4, o.rounding = 1, n = i.d.length, n < 3) i = Pr(o, 2, i, i, true);
        ...
        e = 1.4 * Math.sqrt(n), e = e > 16 ? 16 : e | 0, i = i.times(1 / yn(5, e)), i = Pr(o, 2, i, i, true);
    ...
    m.logarithm = m.log = function(e) {
      ...
      if (w = false, a = p + f, s = Je(u, a), n = r ? fn(c, a + 10) : Je(e, a), l = L(s, n, a, 1), at(l.d, i = p, d)) do
    ...
    m.sine = m.sin = function() {
      var e, r, t = this, n = t.constructor;
      return t.isFinite() ? t.isZero() ? new n(t) : (e = n.precision, r = n.rounding, n.precision = e + Math.max(t.e, t.sd()) + E, n.rounding = 1, t = Cp(n, Ks(n, t)), n.precision = e, n.rounding = r, y(Le > 2 ? t.neg() : t, e, r, true)) : new n(NaN);
    };
    ...
    function fn(e, r, t) {
      if (r > Tp) throw w = true, t && (e.precision = t), Error(Vs);
      return y(new e(dn), r, 1, true);
    }
    function we(e, r, t) {
      if (r > Ui) throw Error(Vs);
      return y(new e(mn), r, t, true);
    }
    function Qs(e) {
    ...
    function Je(e, r) {
      ...
      } else return u = fn(P, c + 2, b).times(o + ""), g = Je(new P(n + "." + t.slice(1)), c - h).plus(u), P.precision = b, r == null ? y(g, b, R, w = true) : g;
    ...
    function Rp(e, r) {
      ...
      return o < 0 ? new n(e.s * 0) : (e.e = hn(u, c), e.d = u, w = false, s && (e = L(e, i, a * 4)), l && (e = e.times(Math.abs(l) < 54 ? U(2, l) : sr.pow(2, l))), w = true, e);
    }
    function Cp(e, r) {
      var t, n = r.d.length;
...
`);
    ...
    var Tn = (e) => e;
    var Sn = { bold: Tn, red: Tn, green: Tn, dim: Tn, enabled: false };
...
`);
    ...
    function Dn({ args: e, errors: r, errorFormat: t, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
      ...
      let { message: l, args: u } = kn(a, t), c = xn({ message: l, callsite: n, originalMethod: i, showColors: t === "pretty", callArguments: u });
    ...
    function xa(e, r, t) {
      return t ? xr(t, ({ needs: n, compute: i }, o) => ({ name: o, needs: n ? Object.keys(n).filter((s) => n[s]) : [], compute: em(r, o, i) })) : {};
    }
    function em(e, r, t) {
      let n = e?.[r]?.compute;
    ...
    var Zi = class e {
      ...
      throwValidationError(r) {
        Dn({ errors: [r], originalMethod: this.params.originalMethod, args: this.params.rootArgs ?? {}, callsite: this.params.callsite, errorFormat: this.params.errorFormat, clientVersion: this.params.clientVersion, globalOmit: this.params.globalOmit });
      }
      getSelectionPath() {
    ...
    var $n = { enumerable: true, configurable: true, writable: true };
    function qn(e) {
      let r = new Set(e);
      return { getPrototypeOf: () => Object.prototype, getOwnPropertyDescriptor: () => $n, has: (t, n) => r.has(n), set: (t, n, i) => r.add(n) && Reflect.set(t, n, i), ownKeys: () => [...r] };
    }
    ...
    function $r({ error: e, user_facing_error: r }, t, n) {
      return r.error_code ? new z4(mm(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx }) : new j(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
    }
    function mm(e, r) {
      let t = e.message;
...
`);
    ...
    var so = (e, r) => Wa(r).reduce((t, n) => t && t[n], e);
    var Ja = (e, r, t) => Wa(r).reduceRight((n, i, o, s) => Object.assign({}, so(e, s.slice(0, o)), { [i]: n }), t);
    function Om(e, r) {
    ...
    function lo(e, r) {
      let t = e._extensions.getAllModelExtensions(r) ?? {}, n = [Mm(e, r), qm(e, r), xt(t), re("name", () => r), re("$name", () => r), re("$parent", () => e._appliedParent)];
      return he({}, n);
    }
    function Mm(e, r) {
    ...
    var uo = Symbol();
    function Pt(e) {
      let r = [jm(e), Vm(e), re(uo, () => e), re("$parent", () => e._appliedParent)], t = e._extensions.getAllClientExtensions();
    ...
    function Vn({ visitor: e, result: r, args: t, runtimeDataModel: n, modelName: i }) {
      if (Array.isArray(r)) {
        for (let s = 0; s < r.length; s++) r[s] = Vn({ result: r[s], args: t, modelName: i, runtimeDataModel: n, visitor: e });
        return r;
      }
      let o = e(r, i, t) ?? r;
    ...
    function Xa({ result: e, modelName: r, args: t, extensions: n, runtimeDataModel: i, globalOmit: o }) {
      return n.isEmpty() || e == null || typeof e != "object" || !i.models[r] ? e : Vn({ result: e, args: t ?? {}, modelName: r, runtimeDataModel: i, visitor: (a, l, u) => {
        let c = Se(l);
...
Learn how: https://pris.ly/d/${ul[r]}-build`;
    ...
    var Hm = () => !!globalThis.Bun || !!globalThis.process?.versions?.bun;
    var Km = () => !!globalThis.Deno;
...
${er(e)}`;
    ...
    async function yl(e, r) {
      ...
      let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d) => d.native), l = !s.some((d) => d.value === o), u = __filename.match(nf()) === null, c = { searchedLocations: i, generatorBinaryTargets: s, generator: r.generator, runtimeBinaryTarget: o, queryEngineName: bl(e, o), expectedLocation: St.default.relative(process.cwd(), r.dirname), errorStack: new Error().stack }, p;
...
`;
    ...
    var sf = (e, r) => ({ adapterName: r.adapterName, provider: r.provider, options: r.options, queryRaw: Me(e, r.queryRaw.bind(r)), executeRaw: Me(e, r.executeRaw.bind(r)), commit: Me(e, r.commit.bind(r)), rollback: Me(e, r.rollback.bind(r)) });
    function Me(e, r) {
      return async (...t) => {
        try {
          return Wn(await r(...t));
    ...
    var Kn = class {
      ...
      build({ traceparent: r, transactionId: t } = {}) {
        let n = { Accept: "application/json", Authorization: `Bearer ${this.apiKey}`, "Content-Type": "application/json", "Prisma-Engine-Hash": this.engineHash, "Prisma-Engine-Version": Cl.enginesVersion };
    ...
    var Rt = class extends $ {
      ...
      code = "P5000";
      constructor(r, t, n) {
        super(t || go, C(r, false)), n && (this.code = n);
      }
    };
    ...
    var Br = class extends $ {
      ...
      logs;
      constructor(r, t, n) {
        super(t || bo, C(r, true)), this.logs = n;
      }
    };
    x(Br, "ServerError");
...
You may have to run ${qe("prisma generate")} for your changes to take effect.`, this.config.clientVersion);
      ...
      async start() {
        ...
        let r = async () => {
          ...
          try {
            ...
            await this.engine?.connect(JSON.stringify(t)), this.libraryStarted = true, this.adapterPromise || (this.adapterPromise = this.config.adapter?.connect()?.then(Jn)), await this.adapterPromise, Ce("library started");
          } catch (t) {
      ...
      async stop() {
        ...
        let r = async () => {
          ...
          let t = { traceparent: this.tracingHelper.getTraceParent() };
          await this.engine?.disconnect(JSON.stringify(t)), this.engine?.free && this.engine.free(), this.engine = void 0, this.libraryStarted = false, this.libraryStoppingPromise = void 0, this.libraryInstantiationPromise = void 0, await (await this.adapterPromise)?.dispose(), this.adapterPromise = void 0, Ce("library stopped");
        };
...
`);
    ...
    var Co = ({ clientMethod: e, activeProvider: r }) => (t) => {
      let n = "", i;
      if (Mn(t)) n = t.sql, i = { values: Qr(t.values), __prismaRawParameters__: true };
    ...
    var ri = class {
      ...
      handleRequestError({ error: r, clientMethod: t, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
        ...
        let l = r.message;
        if (n && (l = xn({ callsite: n, originalMethod: t, isPanic: r.isPanic, showColors: this.client._errorFormat === "pretty", message: l })), l = this.sanitizeMessage(l), r.code) {
...
var require_prisma = __commonJS({
  "src/generated/prisma/index.js"(exports2) {
    ...
    exports2.Prisma.ActivityScalarFieldEnum = {
      id: "id",
      userId: "userId",
      title: "title",
    ...
    exports2.Prisma.WeekScalarFieldEnum = {
      id: "id",
      userId: "userId",
      startDate: "startDate",
      endDate: "endDate",
    ...
    exports2.ActivityType = exports2.$Enums.ActivityType = {
      PESSOAL: "PESSOAL",
      TRABALHO: "TRABALHO",
      ESTUDO: "ESTUDO",
      SAUDE: "SAUDE",
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/usuario/Documentos/personal__projects/routinely-api/src/generated/prisma",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/usuario/Documentos/personal__projects/routinely-api/prisma/schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    config.runtimeDataModel = JSON.parse('{"models":{"User":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"email","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"password","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"avatar","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"preferences","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Json","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true},{"name":"activities","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Activity","nativeType":null,"relationName":"ActivityToUser","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"weeks","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Week","nativeType":null,"relationName":"UserToWeek","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"googleId","kind":"scalar","isList":false,"isRequired":false,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"googleAccessToken","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"googleRefreshToken","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Activity":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"title","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"description","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"type","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"ActivityType","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"startTime","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"endTime","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"date","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"completed","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"Boolean","nativeType":null,"default":false,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"ActivityToUser","relationFromFields":["userId"],"relationToFields":["id"],"relationOnDelete":"Cascade","isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Week":{"dbName":null,"schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"userId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"startDate","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"endDate","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"isActive","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"Boolean","nativeType":null,"default":true,"isGenerated":false,"isUpdatedAt":false},{"name":"isCompleted","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"Boolean","nativeType":null,"default":false,"isGenerated":false,"isUpdatedAt":false},{"name":"weekNumber","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Int","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"createdAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updatedAt","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":true},{"name":"completedAt","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"UserToWeek","relationFromFields":["userId"],"relationToFields":["id"],"relationOnDelete":"Cascade","isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false}},"enums":{"ActivityType":{"values":[{"name":"PESSOAL","dbName":null},{"name":"TRABALHO","dbName":null},{"name":"ESTUDO","dbName":null},{"name":"SAUDE","dbName":null},{"name":"OUTRO","dbName":null}],"dbName":null}},"types":{}}');
...
var MetodsDatabase = class {
  ...
  async getUserById(userId) {
    ...
    return {
      ...
      preferences: user.preferences ? JSON.parse(user.preferences) : void 0
    };
  }
  ...
  async updateUser(userId, data) {
    const user = await prisma.user.update({
      ...
      data: {
        ...
        email: data.email,
        avatar: data.avatar,
        preferences: data.preferences ? JSON.stringify(data.preferences) : void 0
      },
      select: {
        id: true,
        name: true,
  ...
  async changePassword(userId, currentPassword, newPassword) {
    ...
    if (!user.password) {
      throw new Error("Usu\xE1rio n\xE3o possui senha definida");
    }
  ...
  async getUserStats(userId) {
    ...
    const completedActivities = activities.filter((a) => a.endTime < (/* @__PURE__ */ new Date()).toISOString()).length;
    const pendingActivities = totalActivities - completedActivities;
    const totalHours = activities.reduce((total, activity) => {
      const start = /* @__PURE__ */ new Date(`2000-01-01T${activity.startTime}`);
      const end = /* @__PURE__ */ new Date(`2000-01-01T${activity.endTime}`);
      const hours = (end.getTime() - start.getTime()) / (1e3 * 60 * 60);
      return total + hours;
    }, 0);
    const activityTypes = activities.map((a) => a.type);
    const favoriteActivityType = activityTypes.length > 0 ? activityTypes.sort(
      (a, b) => activityTypes.filter((v) => v === a).length - activityTypes.filter((v) => v === b).length
    ).pop() || "OUTRO" : "OUTRO";
  ...
  async getAllByUserId(userId, date, startDate, endDate) {
    const where = { userId };
  ...
  async toggleActivityCompleted(activityId, userId) {
    const activity = await prisma.activity.findFirst({
      where: {
        id: activityId,
        userId
...
var Usecases = class {
  ...
  async create(data) {
    const createSchema = import_zod.z.object({
      name: import_zod.z.string().max(20, { message: "The name must have a maximum of 20 characters" }),
      email: import_zod.z.string().email({ message: "Invalid email format" }),
      password: import_zod.z.string().min(4, { message: "Password must have at least 4 characters" })
    });
  ...
  async Login(data) {
    const loginUser = import_zod.z.object({
      email: import_zod.z.string().email({ message: "Invalid email format" }),
      password: import_zod.z.string().min(4, { message: "Password must have at least 4 characters" })
    });
    ...
    const isPasswordCorrect = await import_bcryptjs2.default.compare(_data.data.password, user.password);
  ...
  async Activities(userId, date, startDate, endDate) {
    const activitiesUser = import_zod.z.object({ userId: import_zod.z.string({ message: "UserId not found!" }) });
  ...
  async CreateActivitie(data, userId) {
    const createActivitySchema = import_zod.z.object({
      title: import_zod.z.string().min(1),
      description: import_zod.z.string().optional(),
      type: import_zod.z.enum(["PESSOAL", "TRABALHO", "ESTUDO", "SAUDE", "OUTRO"]),
      startTime: import_zod.z.string(),
      endTime: import_zod.z.string(),
      date: import_zod.z.string()
    });
    const userIdSchema = import_zod.z.string({ message: "UserId not found!" });
  ...
  async updateActivity(userId, activityId, updateDate) {
    const updateActivitySchema = import_zod.z.object({
      userId: import_zod.z.string(),
      activityId: import_zod.z.string()
    });
    const _updateActivity = updateActivitySchema.safeParse({ userId, activityId });
    if (!_updateActivity.success) {
      throw new Error(JSON.stringify(_updateActivity.error.format()));
    }
  ...
  async deleteActivitie(userId, activityId) {
    const updateActivitySchema = import_zod.z.object({
      userId: import_zod.z.string(),
      activityId: import_zod.z.string()
    });
  ...
  async toggleActivityCompleted(userId, activityId) {
    const toggleActivitySchema = import_zod.z.object({
      userId: import_zod.z.string(),
      activityId: import_zod.z.string()
    });
    const _toggleActivity = toggleActivitySchema.safeParse({ userId, activityId });
    if (!_toggleActivity.success) {
      throw new Error(JSON.stringify(_toggleActivity.error.format()));
    }
...
var Usecases2 = class {
  ...
  async create(data) {
    const createSchema = import_zod2.z.object({
      name: import_zod2.z.string().max(20, { message: "The name must have a maximum of 20 characters" }),
      email: import_zod2.z.string().email({ message: "Invalid email format" }),
      password: import_zod2.z.string().min(4, { message: "Password must have at least 4 characters" })
    });
    const _data = createSchema.safeParse(data);
    if (!_data.success) {
      throw new Error(JSON.stringify(_data.error.format()));
    ...
    const hashedPassword = await import_bcryptjs3.default.hash(data.password, 10);
    const responseDataBase = await this.repositorie.create({
      ..._data.data,
      password: hashedPassword
    });
  ...
  async Login(data) {
    const loginUser = import_zod2.z.object({
      email: import_zod2.z.string().email({ message: "Invalid email format" }),
      password: import_zod2.z.string().min(4, { message: "Password must have at least 4 characters" })
    });
    const _data = loginUser.safeParse(data);
    ...
    const isPasswordCorrect = await import_bcryptjs3.default.compare(_data.data.password, user.password);
    if (!isPasswordCorrect) {
      throw new Error("Incorrect password");
    }
    if (!process.env.JWT_SECRET) {
  ...
  async updateUserProfile(userId, data) {
    const updateSchema = import_zod2.z.object({
      ...
      preferences: import_zod2.z.object({
        theme: import_zod2.z.enum(["light", "dark", "auto"]).optional(),
        language: import_zod2.z.enum(["pt-BR", "en-US", "es"]).optional(),
        notifications: import_zod2.z.boolean().optional(),
    ...
    const updateData = {};
    if (_data.data.name !== void 0) updateData.name = _data.data.name;
    if (_data.data.email !== void 0) updateData.email = _data.data.email;
    if (_data.data.avatar !== void 0) updateData.avatar = _data.data.avatar;
    if (_data.data.preferences !== void 0) {
      const prefs = {};
      if (_data.data.preferences.theme !== void 0) prefs.theme = _data.data.preferences.theme;
      if (_data.data.preferences.language !== void 0) prefs.language = _data.data.preferences.language;
      if (_data.data.preferences.notifications !== void 0) prefs.notifications = _data.data.preferences.notifications;
      if (_data.data.preferences.timezone !== void 0) prefs.timezone = _data.data.preferences.timezone;
      if (_data.data.preferences.dateFormat !== void 0) prefs.dateFormat = _data.data.preferences.dateFormat;
  ...
  async changeUserPassword(userId, data) {
    const changePasswordSchema = import_zod2.z.object({
      currentPassword: import_zod2.z.string().min(4, { message: "Senha atual deve ter pelo menos 4 caracteres" }),
      newPassword: import_zod2.z.string().min(4, { message: "Nova senha deve ter pelo menos 4 caracteres" })
    });
  ...
  async Activities(userId, date, startDate, endDate) {
    const activitiesUser = import_zod2.z.object({ userId: import_zod2.z.string({ message: "UserId not found!" }) });
    const parsed = activitiesUser.safeParse({ userId });
    if (!parsed.success) {
      throw new Error(JSON.stringify(parsed.error.format()));
    }
  ...
  async CreateActivitie(data, userId) {
    const createActivitySchema = import_zod2.z.object({
      title: import_zod2.z.string().min(1),
      description: import_zod2.z.string().optional(),
      type: import_zod2.z.enum(["PESSOAL", "TRABALHO", "ESTUDO", "SAUDE", "OUTRO"]),
      startTime: import_zod2.z.string(),
      endTime: import_zod2.z.string(),
      date: import_zod2.z.string().regex(/^\d{4}-\d{2}-\d{2}$/)
    });
    const userIdSchema = import_zod2.z.string({ message: "UserId not found!" });
    const _activitie = createActivitySchema.safeParse(data);
    const _userId = userIdSchema.safeParse(userId);
    if (!_activitie.success) {
      throw new Error(JSON.stringify(_activitie.error.format()));
  ...
  async updateActivity(userId, activityId, updateDate) {
    const updateActivitySchema = import_zod2.z.object({
      userId: import_zod2.z.string(),
      activityId: import_zod2.z.string()
    });
    const _updateActivity = updateActivitySchema.safeParse({ userId, activityId });
    if (!_updateActivity.success) {
      throw new Error(JSON.stringify(_updateActivity.error.format()));
    ...
    if (!updateDate.date || !/^\d{4}-\d{2}-\d{2}$/.test(updateDate.date)) {
      throw new Error("Campo date inv\xE1lido ou ausente. Formato esperado: YYYY-MM-DD");
    }
  ...
  async toggleActivityCompleted(userId, activityId) {
    const toggleActivitySchema = import_zod2.z.object({
      userId: import_zod2.z.string(),
      activityId: import_zod2.z.string()
    });
    const _toggleActivity = toggleActivitySchema.safeParse({ userId, activityId });
...
// src/routers/route.login.ts
async function UserLogin(app2) {
  app2.post("/userLogin", async (request, reply) => {
    const data = request.body;
    try {
      const usecase = new Usecases2();
...
async function authenticate(request, reply) {
  ...
  try {
    ...
    const payload = import_jsonwebtoken3.default.verify(token, JWT_SECRET);
    request.user = {
      id: payload.userId,
      email: payload.email
    };
...
async function ActivitiesUser(app2) {
  app2.get("/activities", { preHandler: authenticate }, async (request, reply) => {
...
// src/routers/route.create.activities.ts
async function CreateActivities(app2) {
  app2.post("/activities", { preHandler: authenticate }, async (request, reply) => {
    const data = request.body;
    const userId = request.user.id;
    try {
      const usecase = new Usecases2();
...
// src/routers/route.edit.activities.ts
async function EditActivities(app2) {
  app2.put("/activities/:id", { preHandler: authenticate }, async (request, reply) => {
    const data = request.body;
    const userId = request.user.id;
...
// src/routers/route.delete.activities.ts
async function DeleteActivities(app2) {
  app2.delete("/activities/:id", { preHandler: authenticate }, async (request, reply) => {
    const userId = request.user.id;
    const activityId = request.params.id;
...
// src/routers/route.toggle.activity.ts
async function ToggleActivityCompleted(app2) {
  app2.patch("/activities/:activityId/toggle", { preHandler: authenticate }, async (request, reply) => {
...
// src/routers/route.user.profile.ts
async function UserProfile(app2) {
  app2.get("/user/profile", { preHandler: authenticate }, async (request, reply) => {
    const userId = request.user.id;
    try {
      const usecase = new Usecases2();
  ...
  app2.put("/user/profile", { preHandler: authenticate }, async (request, reply) => {
    const userId = request.user.id;
    const data = request.body;
    try {
      const usecase = new Usecases2();
  ...
  app2.delete("/user/profile", { preHandler: authenticate }, async (request, reply) => {
    const userId = request.user.id;
    try {
      const usecase = new Usecases2();
  ...
  app2.put("/user/password", { preHandler: authenticate }, async (request, reply) => {
    const userId = request.user.id;
    const data = request.body;
    try {
      const usecase = new Usecases2();
  ...
  app2.get("/user/stats", { preHandler: authenticate }, async (request, reply) => {
    const userId = request.user.id;
    try {
      const usecase = new Usecases2();
...
// src/routers/route.auth.google.ts
...
async function googleAuthRoutes(fastify2) {
  fastify2.get("/api/auth/google", async (request, reply) => {
  ...
  fastify2.get("/api/auth/google/callback", async (request, reply) => {
    const { code } = request.query;
    if (!code) {
      return reply.status(400).send({ error: "C\xF3digo n\xE3o informado pelo Google." });
    }
    try {
      const { tokens } = await client.getToken(code);
      if (!tokens.id_token || !tokens.access_token) {
        return reply.status(400).send({ error: "Tokens n\xE3o recebidos do Google." });
      }
      ...
      if (!payload || !payload.email) {
        return reply.status(400).send({ error: "Dados do usu\xE1rio n\xE3o recebidos do Google." });
      }
      let user = await prisma.user.findUnique({ where: { email: payload.email } });
      if (!user) {
        user = await prisma.user.create({
          data: {
            name: payload.name || "Usu\xE1rio Google",
            email: payload.email,
      ...
      const appJwt = import_jsonwebtoken4.default.sign({ userId: user.id, email: user.email }, process.env.JWT_SECRET || "default_secret", { expiresIn: "7d" });
      reply.redirect(`${process.env.GOOGLE_REDIRECT_URI_FRONTEND || "http://localhost:5173"}/auth/callback?token=${appJwt}`);
    } catch (err) {
      reply.status(500).send({ error: "Erro ao autenticar com Google", details: err.message });
    }
  });
}

// src/routers/route.weeks.ts
var import_zod3 = require("zod");
async function weekRoutes(fastify2) {
  fastify2.get("/api/weeks", { preHandler: [authenticate] }, async (request, reply) => {
    const userId = request.user.id;
  ...
  fastify2.post("/api/weeks", { preHandler: [authenticate] }, async (request, reply) => {
    const userId = request.user.id;
    const bodySchema = import_zod3.z.object({
      startDate: import_zod3.z.string().datetime(),
      endDate: import_zod3.z.string().datetime(),
      weekNumber: import_zod3.z.number().int()
    });
  ...
  fastify2.patch("/api/weeks/:id/complete", { preHandler: [authenticate] }, async (request, reply) => {
    const userId = request.user.id;
    const { id } = request.params;
    const week = await prisma.week.findUnique({ where: { id } });
    if (!week || week.userId !== userId) {
      return reply.code(404).send({ error: "Semana n\xE3o encontrada" });
    }
  ...
  fastify2.get("/api/weeks/completed", { preHandler: [authenticate] }, async (request, reply) => {
    const userId = request.user.id;
  ...
  fastify2.get("/api/weeks/check-expired", { preHandler: [authenticate] }, async (request, reply) => {
    const userId = request.user.id;
...
var App = class {
  constructor() {
    ...
    this.PORT = process.env.PORT ? Number(process.env.PORT) : 3e3;
  }
  getServer() {
    return this.app;
  }
  ...
  register() {
    this.app.register(import_cors.fastifyCors, {
      origin: "*",
